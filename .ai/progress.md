...
- 星云寻知当前发行目标为 `v0.1.6.2`，版本号与社区上游一致；社区版已完成的矩阵和安装证据不能替代星云寻知品牌构建的独立发布验收。
...
- Harness 默认来源为 `https://github.com/xingyunxunzhi/xingyunxunzhi-harness.git`，锁定星云寻知品牌 commit；其代码基线为社区版 `ddefc45fbc7f8e46dd73185e68295696d1297887`（`0.1.6-alpha.2`），核心行为保持一致。
