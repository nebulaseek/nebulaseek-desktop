...
- Harness 默认来源为 `https://github.com/nebulaseek/nebulaseek-harness.git`，锁定专版 commit `a20f09c13af60a813e2832b39891298cd3114b5e`（`dsh-v0.1.6-alpha.2.nebulaseek.1`）；其代码基线为社区版 `ddefc45fbc7f8e46dd73185e68295696d1297887`（`0.1.6-alpha.2`），核心行为保持一致。
