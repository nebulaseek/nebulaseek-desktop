...
- 未发布品牌显示调整：窗口标题与侧栏字标按简体、繁体、英文显示“星云寻知” / “星雲尋知” / `NebulaSeek`；源码锁定专版 Harness `309b9a92569c7f4074c75057d76c57f4ec5e4bda`。安装包名称和路径保持 `NebulaSeek`，已发布 `v0.1.6.4` 安装包未被修改。本对话仅维护专版，不向社区版对话派发任务或修改社区仓库。
