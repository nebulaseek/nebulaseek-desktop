...
export const messages = {
  "zh-CN": {
    ...
    harnessUpdate: {
      ...
      channelHelp: "临时规则：alpha、beta 属于预览版，其余版本（含 RC）属于稳定版。",
      messages: { repository_timeout: "Harness 仓库连接超时，请检查网络或代理后重试。当前版本未受影响。", ignored_version: "候选版本不属于所选频道，继续使用当前 Harness。", idle: "尚未检查 Harness 更新。", not_configured: "未配置 Harness 仓库。", checking: "正在检查 Harness 仓库。", available: "发现 Harness {version}。", up_to_date: "当前 Harness 已是最新版本。", downloading: "正在下载并校验 Harness。", preparing_repository: "正在从仓库拉取、构建并验证 Harness。", applying: "正在安装并验证新 Harness，请稍候。", restart_to_apply: "Harness {version} 已就绪，将在下次启动切换。", applied: "Harness 更新已安装。", check_failed: "Harness 仓库检查失败，当前版本未受影响。", download_failed: "Harness 准备或校验失败，当前版本未受影响。", smoke_failed: "新 Harness 启动验证失败，已保留当前版本。", pinned: "当前 Harness 已固定，不会自动更新。", bundled_restored: "已恢复安装包内置 Harness。", startup_rollback: "新 Harness 启动失败，已自动回滚。" }
    },
  ...
  "zh-TW": {
    ...
    harnessUpdate: {
      ...
      channelHelp: "暫行規則：alpha、beta 屬於預覽版，其餘版本（含 RC）屬於穩定版。",
      messages: { repository_timeout: "Harness 倉庫連線逾時，請檢查網路或代理後重試。目前版本未受影響。", ignored_version: "候選版本不屬於所選頻道，繼續使用目前的 Harness。", idle: "尚未檢查 Harness 更新。", not_configured: "未設定 Harness 倉庫。", checking: "正在檢查 Harness 倉庫。", available: "發現 Harness {version}。", up_to_date: "目前 Harness 已是最新版本。", downloading: "正在下載並驗證 Harness。", preparing_repository: "正在從倉庫拉取、構建並驗證 Harness。", applying: "正在安裝並驗證新 Harness，請稍候。", restart_to_apply: "Harness {version} 已準備完成，將在下次啟動切換。", applied: "Harness 更新已安裝。", check_failed: "Harness 倉庫檢查失敗，目前版本未受影響。", download_failed: "Harness 準備或驗證失敗，目前版本未受影響。", smoke_failed: "新 Harness 啟動驗證失敗，已保留目前版本。", pinned: "目前 Harness 已固定，不會自動更新。", bundled_restored: "已還原安裝包內建 Harness。", startup_rollback: "新 Harness 啟動失敗，已自動回復。" }
    },
